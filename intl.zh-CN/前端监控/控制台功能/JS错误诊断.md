...
-   将鼠标悬浮于曲线拐点上，当鼠标显示为手形指针时单击拐点，可打开该时间点的**异常洞察**对话框。更多信息，请参见[\#sc\_js\_error\_insight](#sc_js_error_insight)。
...
-   如何开启或关闭用户行为回溯功能？
    ...
    该功能默认开启。如需关闭，请在config配置中添加SDK配置项behavior: false。SDK配置项的详细信息参见[SDK参考](/intl.zh-CN/前端监控/SDK参考.md)。
