...
**Note:** You can call the **ImportAppAlertRules** operation to import only the alert rules that are generated by Application Real-Time Monitoring Service \(ARMS\) for application monitoring and frontend monitoring. This operation cannot be used to import custom alert rules, alert rules for Prometheus monitoring, or default emergency alert rules.

## Debugging

[OpenAPI Explorer automatically calculates the signature value. For your convenience, we recommend that you call this operation in OpenAPI Explorer. OpenAPI Explorer dynamically generates the sample code of the operation for different SDKs.](https://api.aliyun.com/#product=ARMS&api=ImportAppAlertRules&type=RPC&version=2019-08-08)

## Request parameters

|Parameter|Type|Required|Example|Description|
|---------|----|--------|-------|-----------|
|Action|String|Yes|ImportAppAlertRules|The operation that you want to perform. Set the value to `ImportAppAlertRules`. |
|Pids|String|Yes|\["atc889zkcf@d8deedfa9bfxxxx", "acd129bfcf@d5daebfa6cdxxxx"\]|The process identifiers \(PIDs\) of the applications associated with the alert rule. The value must be a JSON array. |
|RegionId|String|Yes|cn-hangzhou|The ID of the region where the associated applications reside. |
|TemplateAlertId|String|No|324324234|The ID of the alert template based on which you want to create an alert rule. You must set at least one of the **TemplateAlertId** and **TemplageAlertConfig** parameters. If you set both parameters, the **TemplateAlertId** parameter prevails. |
|ContactGroupIds|String|No|\[123, 234\]|The IDs of the alert contact groups. The value must be a JSON array. |
|IsAutoStart|Boolean|No|true|Specifies whether to enable the alert rule after it is created. Default value: `false`. Valid values:

 -   `true`: enables the alert rule.
-   `false`: disables the alert rule. |
|TemplageAlertConfig|String|No|\[ \{ "contactGroupIds": "381", "alertType": 5, "alarmContext": \{ "subTitle": "", "content": "Alert name: $alert name\\nFilter condition: $filter\\nAlert time: $alert time\\nAlert content: $alert content\\nNote: The alert is continuously triggered until a reply email is received. The system will remind you 24 hours later." \}, "alertLevel": "WARN", "metricParam": \{ "appId": "70901", "pid": "atc889zkcf@d8deedfa9bf\*\*\*\*", "type": "TXN", "dimensions": \[ \{ "type": "STATIC", "value": "\\\\/hello\_test\_api\_address\\\\/test1", "key": "rpc" \} \] \}, "alertWay": \[ "SMS", "MAIL", "DING\_ROBOT" \], "alertRule": \{ "rules": \[ \{ "measure": "appstat.txn.rt", "alias": "API call response time\_ms", "aggregates": "AVG", "nValue": 1, "value": 1, "operator": "CURRENT\_GTE" \} \], "operator": "\|" \}, "title": "Template alert name", "config": "\{\\"continuous\\":false,\\"dataRevision\\":2,\\"ownerId\\":\\"123412341234\\"\}", "notice": \{ "noticeStartTime": 1480521600000, "startTime": 1480521600000, "endTime": 1480607940000, "noticeEndTime": 1480607940000 \}, "status": "NON" \} \]|The configuration of the alert template based on which you want to create an alert rule. The value must be a JSON string. You must set at least one of the **TemplateAlertId** and **TemplageAlertConfig** parameters. If you set both parameters, the **TemplateAlertId** parameter prevails. For more information about the TemplageAlertConfig parameter, see the following **additional information about the TemplageAlertConfig parameter**. |

## Additional information about the **TemplageAlertConfig** parameter

**Generate the JSON string of an alert template in the ARMS console**

1. In the ARMS console, choose **Alerts \> Alert Policies** in the left-side navigation pane. On the Alarm Policies page, create an application monitoring alert as a template.

2. On the **Alarm Policies** page, select the created alert template and click **Batch Export Alerts** in the lower part of the page.

3. In the **Alarm Rule Export** dialog box, copy the JSON string that is generated by ARMS for the alert template.
...
[
  {
    ...
    "alertType": 5,                                   // The alert type. Valid values: 4 and 5. The value 4 indicates frontend monitoring. The value 5 indicates application monitoring. 
