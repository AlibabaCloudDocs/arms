...
**Note:** You can manually report custom performance metrics. You can customize first paint time, time to interact, or other performance metrics. For more information, see [performance\(\)](/intl.en-US/Browser monitoring/Methods user guide.md).
...
-   [Custom performance metrics that are manually reported](/intl.en-US/Browser monitoring/Methods user guide.md)
