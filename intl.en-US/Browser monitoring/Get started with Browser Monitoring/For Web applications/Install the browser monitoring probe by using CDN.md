...
The browser monitoring feature of ARMS also provides more SDK configuration items to further meet your requirements. For more information, see [SDK reference](/intl.en-US/Browser monitoring/SDK reference.md).
