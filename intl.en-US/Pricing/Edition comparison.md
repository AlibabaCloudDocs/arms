...
Monitors heap memory metrics, non-heap memory metrics, direct buffer metrics, memory-mapped buffer metrics, garbage collection \(GC\) details, and the number of JVM threads.|✔️|✔️|
...
Monitors host metrics such as CPU, memory, disk, load, network traffic, and network packets.|✔️|✔️|
|[SQL analysis, NoSQL analysis, exception analysis, and error analysis](/intl.en-US/Application monitoring/Features provided by the console/API monitoring.md)

Displays and analyzes SQL statements, exceptions, and errors by application, instance, and API.|❌|✔️|
|[Interface snapshot](/intl.en-US/Application monitoring/Features provided by the console/API monitoring.md)

Displays interface snapshots by application, instance, and API.|✔️|✔️|
|Interface invocation|
|Overview

Automatically identifies call relationships between applications or interfaces, and then generates a real-time topological graph.|❌|✔️|
|[SQL analysis and NoSQL analysis](/intl.en-US/Application monitoring/Features provided by the console/API monitoring.md)

Analyzes SQL statements by application, instance, and interface. This allows you to diagnose the causes of slow calls.|❌|✔️|
|[Exception analysis](/intl.en-US/Application monitoring/Features provided by the console/API monitoring.mdsc_view_interface_exception)

Analyzes the drill-down information of exceptions by application, instance, and interface.|❌|✔️|
|[Error analysis](/intl.en-US/Application monitoring/Features provided by the console/API monitoring.mdsc_view_interface_errors)

Displays the statistics of application errors and HTTP status codes.|❌|✔️|
|[Upstream services and downstream services](/intl.en-US/Application monitoring/Features provided by the console/API monitoring.md)

Displays the statistics of the APIs and their invocation performance metrics. The statistics include the number of requests, response time, and number of errors.|❌|✔️|
|[Interface snapshot](/intl.en-US/Application monitoring/Features provided by the console/API monitoring.md)
...
Automatically identifies call relationships between applications and databases, and then generates a real-time topological graph.|❌|✔️|
|[SQL analysis](/intl.en-US/Application monitoring/Features provided by the console/API monitoring.md)

Analyzes SQL statements by application, instance, and interface. This allows you to diagnose the causes of slow calls.|✔️|✔️|
|[Exception analysis](/intl.en-US/Application monitoring/Features provided by the console/API monitoring.mdsc_view_interface_exception)
...
Displays the statistics of metrics, such as the number of external requests, response time, number of errors, and HTTP status codes.|✔️|✔️|
...
|[Install the agent and delete applications](/intl.en-US/Application monitoring/Start monitoring Java applications/Manually install the ARMS agent for a Java application.md)
...
You can set the sampling rate of invocation traces, agent switch, thresholds, and filtering rules for invalid interface invocations.|❌|✔️|
|Trace query|
...
|[Holographic troubleshooting](/intl.en-US/Application monitoring/Tutorials/Diagnose business problems by using comprehensive troubleshooting.md)
...
For information about the pay-as-you-go billing method and the pricing of resource packages of ARMS on the China site \(aliyun.com\) and International site \(alibabacloud.com\), see [ARMS pricing](https://www.alibabacloud.com/product/arms/pricing).
