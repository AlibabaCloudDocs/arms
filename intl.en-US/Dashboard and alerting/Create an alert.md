...
## Create application monitoring alert
...
2.  In the left-side navigation pane, choose **Alarm management** \> **Alert policy management**.

3.  On the alert policy management page, click **Create alarms** \> **Application monitoring alerts**.
...
1.  In the left-side navigation pane, choose **Alarm management** \> **Alert policy management**.

2.  On the alert policy management page, click **Create alarms** \> **Browser monitoring alarm**.
...
3.  In the **create alarm** dialog box, enter all the required information and click **save**.
    ...
    5.  Configure an alert rule.
        ...
        3.  To add another alert rule, click the plus sign \( **+**\) on the right of alarm rules. For example, an alert is triggered when the value of N is 10 and the JavaScript error count is at least 20.
...
|Notification Mode|Email, SMS, ,Ding Ding Robot, and Webhook are supported.|You can select multiple modes. If you need to set a DingTalk robot alarm see . [Set DingTalk robot alert](https://www.alibabacloud.com/help/zh/doc-detail/106247.htm)|
...
|Notification Time|The time when the alert was sent. No alert notification is sent out of this time period, but alert events are recorded.|For more information about viewing alert event records, see . [Manage alarms](https://www.alibabacloud.com/help/zh/doc-detail/42966.htm).|
