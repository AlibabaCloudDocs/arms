...
3.  在弹出的添加 APP 监控对话框的填写应用信息页签输入应用名称和 Android 应用的 PackageName，并选择 **Android** 平台，单击**创建应用**。 
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/1680661/156870342859954_zh-CN.png)

4.  在查看配置页签复制 AppKey 和 AppSecret 的值，单击**下一步**。 

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/1680661/156870342859955_zh-CN.png)
