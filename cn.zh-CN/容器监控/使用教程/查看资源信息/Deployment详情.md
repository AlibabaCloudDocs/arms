...
在Deployment的请求数区域显示了Deployment请求数的时序曲线和Top接口列表。
...
-   在Top列表区域可以选择查看Deployment请求数的Top 5、Top 10或Top 15接口，单击目标接口右侧的**查看列表**，可以查看目标接口关联的接口信息。更多信息，请参见[接口详情](#section_nr2_tn5_qr4)。

## 响应时间

在Deployment的响应时间区域显示了Deployment平均响应时间和P95响应时间的时序曲线，以及Top接口列表。
...
-   使用光标选中一段时间，可以查看指定时间段的统计情况。
-   在Top列表区域可以选择查看Deployment响应时间的Top 5、Top 10或Top 15接口，单击目标接口右侧的**查看列表**，可以查看目标接口关联的接口信息。更多信息，请参见[接口详情](#section_nr2_tn5_qr4)。

## 错误数和慢调用

在Deployment的错误数和慢调用区域显示了Deployment错误数和慢调用的时序曲线，以及Top接口列表。
...
-   使用光标选中一段时间，可以查看指定时间段的统计情况。
-   在Top列表区域可以选择查看Deployment错误数和慢调用的Top 5、Top 10或Top 15接口，单击目标接口右侧的**查看列表**，可以查看目标接口关联的接口信息。更多信息，请参见[接口详情](#section_nr2_tn5_qr4)。
